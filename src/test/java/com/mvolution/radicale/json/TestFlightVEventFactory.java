...
public class TestFlightVEventFactory {

    private final Logger LOG = getLogger(TestFlightVEventFactory.class);
    /*Flight Properties*/
    /*Property Prefixes*/
    ...
    @Test
    public void generateFlightEvent() throws ParseException, IOException {

        TypedEntity jf = JsonEntityFactory.deserialize("/metaplanner-flight.json");

        assertTrue(jf instanceof Flight);
        ...
        VEvent e = new VEvent(props);

        //TEST OUTPUT
        for(net.fortuna.ical4j.model.Property o : props){
